...
function App(props) {
  ...
  return e(
    ...
    React.createElement(
      ...
      React.createElement(GamepadButton,
        { disabled: busy, onClick: function() { doCall("prepare_for_unplug", {}); } },
        e("div", { style: { width: "100%", display: "flex", alignItems: "center", gap: "10px" } },
          e("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", style: { flex: "0 0 auto" } },
            e("path", { d: "M12 4L5.5 13.5H18.5L12 4Z", fill: "rgba(245,248,255,.90)" }),
            e("path", { d: "M6 18.5H18", stroke: "rgba(245,248,255,.90)", strokeWidth: "2.2", strokeLinecap: "round" })
          ),
          e("div", { style: { minWidth: 0 } },
            e("div", { style: { fontSize: "13px", fontWeight: "900" } }, "Safe Unplug"),
            e("div", { style: { fontSize: "10px", fontWeight: "700", opacity: ".72" } }, "Prepare before unplugging USB4/eGPU")
          )
        )
      )
    ),
...
React.createElement(
              ...
              React.createElement(
                  ...
                  "Safe Unplug (Prepare for unplug)" 
                )
            ),
